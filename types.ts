...
export type DbProps = {
  ...
  send: (req: Request, res: Response, qry: string, params?: PlainObject | null) => Promise<void>
  print: DbPrint
}
...
export type UpdateResponseType = { rowsAffected: number }
export type QueryParameters = { [k: string]: any }
